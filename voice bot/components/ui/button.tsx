...
const buttonVariants = cva(
  ...
  ],
  {
    variants: {
      ...
      size: {
        default: 'h-9 px-4 py-2 has-[>svg]:px-3 min-h-[44px] sm:min-h-[36px]', // 44px minimum for mobile touch targets
        sm: 'h-8 gap-1.5 px-3 has-[>svg]:px-2.5 min-h-[40px] sm:min-h-[32px]',
        lg: 'h-10 px-6 has-[>svg]:px-4 min-h-[48px] sm:min-h-[40px]',
        icon: 'size-9 min-w-[44px] min-h-[44px] sm:size-9 sm:min-w-[36px] sm:min-h-[36px]',
      },
    },
    defaultVariants: {
      variant: 'default',
